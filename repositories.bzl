...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:HqfVS5v81r1Q+vWm91V1uqdB77vO48uSjU1LAYC2DyE=",
        version = "v1.17.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Yj4wkrNtyCNLCMobKDYzEUIsbtMbfAulkHMH75/ecik=",
        version = "v23.0.2+incompatible",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:q81C2qQ/EhPm8COZMUGOQYh4qLv4Xu6CXELJ3WK/mlU=",
        version = "v23.0.2+incompatible",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:r8yyd+DJDmsUhGrRBxH5Pj7KeFK5l+Y3FsgT8keqKtk=",
    ...
    go_repository(
        ...
        sum = "h1:xyWBoGyMjYekG3mEQ/W7xm9E05S89kJ/at696d/9yuc=",
        version = "v1.0.1",
    )
    go_repository(
